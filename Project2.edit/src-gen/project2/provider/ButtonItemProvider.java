...
/**
 * This is the item provider adapter for a {@link project2.Button} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ButtonItemProvider extends ConditionItemProvider {
	/**
	...
	protected void addButtonPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Button_button_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Button_button_feature", "_UI_Button_type"),
						Project2Package.Literals.BUTTON__BUTTON, true, false, false,
	...
	public String getText(Object object) {
		String label = ((Button) object).getConditionname();
	...
	public void notifyChanged(Notification notification) {
		...
		case Project2Package.BUTTON__BUTTON:
