 ...
 * </p>
 * <ul>
 *   <li>{@link project2.impl.ExpressionImpl#getOperation <em>Operation</em>}</li>
...
public class ExpressionImpl extends MinimalEObjectImpl.Container implements Expression {
	...
	protected EClass eStaticClass() {
		return Project2Package.Literals.EXPRESSION;
	}
	...
	public void setOperation(String newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Project2Package.EXPRESSION__OPERATION, oldOperation,
					operation));
	}
	...
	public NotificationChain basicSetLeft(Expression newLeft, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Project2Package.EXPRESSION__LEFT, oldLeft, newLeft);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newLeft != left) {
			...
			if (left != null)
				msgs = ((InternalEObject) left).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Project2Package.EXPRESSION__LEFT, null, msgs);
			if (newLeft != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Project2Package.EXPRESSION__LEFT, newLeft, newLeft));
	}
	...
	public NotificationChain basicSetRight(Expression newRight, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Project2Package.EXPRESSION__RIGHT, oldRight, newRight);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newRight != right) {
			...
			if (right != null)
				msgs = ((InternalEObject) right).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Project2Package.EXPRESSION__RIGHT, null, msgs);
			if (newRight != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Project2Package.EXPRESSION__RIGHT, newRight,
					newRight));
	}
	...
	public void setValue(Object newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Project2Package.EXPRESSION__VALUE, oldValue, value));
	}
